 ...
 */
function echartShow(data,seriesData,legendData,chartType, yAxixUnit){
          ...
          formatter: function(params) {
    	    ...
    	    params.forEach(function (item) {
    	        if(item.data){
                    ...
                    result += item.seriesName + " : " + item.data + " " + data.unit + "<br/>";
                }
    	    });
    	    return result;
    	}
...
function showChart(mid,type) {
	...
	$.ajax({
    		...
    		success: function(data, textStatus){
                console.log(data);
                echartShow(data,null,'[a,c]',chartType,data.unit);
    		},
    		error: function(){
    			//请求出错处理
    		}
