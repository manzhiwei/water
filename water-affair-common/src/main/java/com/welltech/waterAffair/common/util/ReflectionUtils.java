...
public class ReflectionUtils {
    ...
    public static Field getAccessibleField(final Object obj, final String fieldName) {
        if (obj == null) {
            throw new IllegalArgumentException(String.format("object can't be null"));
        }
        if (StringUtils.isBlank(fieldName)) {
            throw new IllegalArgumentException(String.format("fieldName can't be blank"));
        }
        for (Class<?> superClass = obj.getClass(); superClass != Object.class; superClass = superClass
                .getSuperclass()) {
            try {
    ...
    public static Method getAccessibleMethod(final Object obj, final String methodName,
        ...
        if (obj == null) {
            throw new NullPointerException(new Formatter().format("object can't be null").toString());
        }
