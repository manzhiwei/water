...
@Mapper
public interface GprsDataFor4200Mapper {
     ...
     * @return
     */
    Map<String,Object> find4200MonthTotalflowData(@Param(value = "num") Integer num,@Param(value = "year") String year,@Param(value = "month") String month,@Param(value = "lastmonth") String lastmonth);
}
